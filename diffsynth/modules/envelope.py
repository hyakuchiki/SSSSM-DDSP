...
class ADSREnvelope(Gen):
    def __init__(self, name='env', channels=1, min_value=0.0, max_value=1.0, frame_rate=60, sample_rate=16000):
    ...
    def forward(self, floor, peak, attack, decay, sus_level, release, n_samples, noise_mag=0.0, note_off=0.8):
        ...
        Args:
            ...
            release (torch.Tensor): release point is note_off+release (batch, 1, channels)
